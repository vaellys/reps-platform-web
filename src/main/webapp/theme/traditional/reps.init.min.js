...
function initLayout() {
	var iContentW = (window.ActiveXObject?document.body.clientWidth:$(window).width()) - (DWZ.ui.sbar ? $("#sidebar").width() + 10 : 34) - 5;
	var iContentH = (window.ActiveXObject?document.body.clientHeight:$(window).height()) - $("#header").height() - 34;
	$("#container").width(iContentW);
	$("#container .tabsPageContent").height(iContentH - 34 - $(".navigate").height()).find("[layoutH]").layoutH();
	$("#sidebar .-left-side-height").height((window.ActiveXObject?(iContentH + 2):iContentH) - 34 - $(".navigate").height());
...
var navTab = {
	...
	_switchTab : function (iTabIndex) {
		...
		this._scrollCurrent();
		var unitBox = $(".unitBox").eq(iTabIndex);
		unitBox.find("iframe").attr("src", unitBox.find("iframe").attr("src")).css({
			"height" : unitBox.parent().height()
		});
		this._reload($tab);
	},
	...
	openExternal : function (url, $panel) {
		...
		var noSrcIframe = DWZ.frag["externalFrag"].replaceAll("{url}", "").replaceAll("{height}", ih + "px")
		$panel.html(noSrcIframe);
...
(function ($) {
	$.pdialog = {
		...
		_init : function (dialog, options) {
			...
			var iTop = ((window.ActiveXObject?document.body.clientHeight:$(window).height()) - dialog.height()) / 2;
			dialog.css({
				left : ((window.ActiveXObject?document.body.clientWidth:$(window).width()) - dialog.width()) / 2,
				top : iTop > 0 ? iTop : 0
			});
		},
